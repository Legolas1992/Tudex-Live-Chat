            ...
            <footer className="composer">
              ...
              <div className="whatsappComposerRow" style={{
                ...
                <div className={`whatsappInputPill ${correcting || correctingAndSending ? "isCorrecting" : ""}`} style={{
                  ...
                  <span style={{ fontSize: '1.25rem', color: '#94a3b8', cursor: 'pointer', userSelect: 'none' }} title="Emojis" role="button" aria-label="Selector de Emojis">
                    😊
                  </span>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '12px' }}>
                    {[
                      ...
                      <button
                        ...
                        title={color} aria-label={`Color: ${color}`} role="button"
                      />
                    ))}
                  </div>
                  <input
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '8px' }}>
                {[
                  ...
                  <button
                    ...
                    title={theme.label} aria-label={`Tema: ${theme.label}`} role="button"
                  />
                ))}
              </div>
            </div>
