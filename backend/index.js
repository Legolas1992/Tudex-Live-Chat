...
const authenticateUser = async (req, res, next) => {
  ...
  try {
    // ⚡ Bolt: Using .lean() in auth middleware to bypass Mongoose document instantiation for lower memory usage and faster read performance.
...
io.use(async (socket, next) => {
  ...
  try {
    // ⚡ Bolt: Using .lean() in websocket auth to bypass Mongoose document instantiation for lower memory usage and faster read performance.
