        ...
        <header className="sidebarHeader">
          <h2>
            ...
            {viewMode === "chats" && syncingChats && (
              <span className="syncIndicator" title="Sincronizando chats..." aria-live="polite" aria-label="Sincronizando chats..."><ReloadIcon size={14} className="spinning" style={{ marginLeft: '6px', display: 'inline-block', verticalAlign: 'middle' }} /></span>
            )}
          </h2>
            ...
            <footer className="composer">
              ...
              <div className="whatsappComposerRow" style={{
                ...
                <div className={`whatsappInputPill ${correcting || correctingAndSending ? "isCorrecting" : ""}`} style={{
                  ...
                  <span role="button" style={{ fontSize: '1.25rem', color: '#94a3b8', cursor: 'pointer', userSelect: 'none' }} title="Emojis" aria-label="Emojis">
                    😊
                  </span>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '8px' }}>
                {[
                  ...
                  <button
                    ...
                    title={theme.label} aria-label={theme.label}
                  />
                ))}
              </div>
            </div>
